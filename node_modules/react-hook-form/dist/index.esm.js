...
const useFieldArray = ({ control, name, keyName = 'id', }) => {
    ...
    return {
        swap: useCallback(swap, [name, errors]),
        move: useCallback(move, [name, errors]),
        prepend: useCallback(prepend$1, [name, errors]),
        append: useCallback(append, [name, errors, fields]),
        remove: useCallback(remove, [fields, name, errors]),
        insert: useCallback(insert$1, [name, errors]),
        fields,
    };
};
